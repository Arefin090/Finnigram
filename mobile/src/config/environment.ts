...
const config: Record<'development' | 'production', Environment> = {
  development: {
...
const environment: keyof typeof config = 'production';

export const { USER_SERVICE_URL, MESSAGE_SERVICE_URL, REALTIME_SERVICE_URL } =
  config[environment];
