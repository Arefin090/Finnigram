...
import { handleConnectionEvents, setupConnectionCleanup } from './events/connectionEvents';
import {
  AuthenticatedSocket,
  HealthStatus,
  MetricsResponse,
...
io.on('connection', (socket) => {
  ...
  logger.info(`New socket connection: ${socket.id} for user ${authSocket.user.username}`);
